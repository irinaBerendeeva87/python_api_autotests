...
class TestAPIBreeds(BaseTest):
    ...
    #Limit parameter: Check the number of returned breeds
    ...
    #Test that breeds pagination works and there are no duplicate entries
    ...
    #Test that an extremely large limit does not crash the API and returns a reasonable number of results
